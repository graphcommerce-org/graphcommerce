...
In the project there's an `components/Layout` directory. This directory contains
all project specific app shell components. Most of them require components to be
given via props, for example in `components/Layout/LayoutDefault.tsx`:
