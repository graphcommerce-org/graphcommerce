...
4. If you haven't already, make sure you have a copy of the GraphCommerce repo
   ...
   cd graphcommerce
   ```
5. `git diff "@graphcommerce/next-ui@OLD_VERSION".."@" examples/magento-graphcms`
6. To get a pretty print of the diff https://diffy.org/: 
7. Manually traverse the diff and apply changes to your project.
