...
- Run tests across all browsers. Execute tests in parallel. Enjoy context
- isolation out of the box. Capture videos, screenshots and other artifacts on
- failure. Integrate your POMs as extensible fixtures.
