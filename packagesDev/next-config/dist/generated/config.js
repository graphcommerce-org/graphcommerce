...
_export(exports, {
  ...
  AlgoliaFilterAttributeSchema: function () {
    return AlgoliaFilterAttributeSchema
  },
  AlgoliaSearchIndexConfigSchema: function () {
    return AlgoliaSearchIndexConfigSchema
  },
  AlgoliaSortableOptionSchema: function () {
    return AlgoliaSortableOptionSchema
  },
...
const CompareVariantSchema = _zod.z.enum(['CHECKBOX', 'ICON'])
const ProductFiltersLayoutSchema = _zod.z.enum(['DEFAULT', 'SIDEBAR'])
...
function GraphCommerceConfigSchema() {
  return _zod.z.object({
    ...
    algoliaHygraphIndex: _zod.z.string().nullish(),
    ...
    hygraphSecret: _zod.z.string().nullish(),
