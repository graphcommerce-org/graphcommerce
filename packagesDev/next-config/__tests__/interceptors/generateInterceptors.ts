...
it('it generates an interceptor', () => {
  ...
  expect(
     ...
     */
    const AddBraintreeMethods_interceptor: typeof AddBraintreeMethods = (props) => (
      <AddBraintreeMethods {...props} Prev={PaymentMethodContextProvider_original} />
    )
    const AddMollieMethods_interceptor: typeof AddMollieMethods = (props) => (
      <AddMollieMethods {...props} Prev={AddBraintreeMethods_interceptor} />
    )
    export const PaymentMethodContextProvider = AddMollieMethods_interceptor as ComponentWithoutPrev<
      typeof AddMollieMethods_interceptor
    >
    "
  `)
})
...
it('it handles on duplicates gracefully', () => {
  ...
  expect(
    ...
    export const PaymentMethodContextProvider = AddBraintreeMethods_interceptor as ComponentWithoutPrev<
      typeof AddBraintreeMethods_interceptor
    >
    "
  `)
})
