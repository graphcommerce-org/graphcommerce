...
export type GraphCommerceConfig = {
  ...
  /**
   * Configure your Algolia HyGraph index. This will create a new index for HyGraph data if it
   * doesn't exist in Algolia.
   */
  algoliaHygraphIndex?: InputMaybe<Scalars['String']['input']>
  ...
  hygraphSecret?: InputMaybe<Scalars['String']['input']>
  /**
...
export function GraphCommerceConfigSchema(): z.ZodObject<Properties<GraphCommerceConfig>> {
  return z.object({
    ...
    algoliaHygraphIndex: z.string().nullish(),
    ...
    hygraphSecret: z.string().nullish(),
