...
const AvailableShippingMethod = React.forwardRef((props: AvailableShippingMethodProps, ref) => {
  const {
    amount,
    available,
    disabled,
  ...
  return (
    ...
    >
      ...
      {error_message ? (
        ...
        children && (
          <Box className={classes.additional} sx={{ typography: 'body2', gridArea: 'additional' }}>
            {children}
          </Box>
        )
      )}
