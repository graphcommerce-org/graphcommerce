...
export const hygraphHomePage: Page = {
  id: 'ckiaaa4a84dzi0a55yeb7s87c',
  __typename: 'Page',
  title: 'Homepage',
  metaTitle: 'Magento PWA',
  metaDescription: 'Progressive Web App',
  ...
  content: [
    {
      ...
      heroAsset: {
        url: 'https://media.graphassets.com/fOotBzWtTTOoCUvaUEpq',
        width: null,
        height: null,
        mimeType: 'video/mp4',
        size: 1761151,
      ...
      pageLinks: [
        {
          ...
          asset: {
            url: 'https://media.graphassets.com/osQkBcCbQxGkCVBa1Gvt',
            width: 800,
            height: 1200,
            mimeType: 'image/jpeg',
            size: 538666,
        ...
        },
        {
          ...
          asset: {
            url: 'https://media.graphassets.com/Ff1fxAUQg6ebTzGqmuwD',
            width: 800,
            height: 1200,
            mimeType: 'image/jpeg',
            size: 876600,
        ...
        },
        {
          ...
          asset: {
            url: 'https://media.graphassets.com/l0mmYMNSYyq7kLvJzDgg',
            width: null,
            height: null,
            mimeType: 'video/mp4',
            size: 348411,
        ...
        },
        {
          ...
          asset: {
            url: 'https://media.graphassets.com/1bNjsZkgQoiaowSa4OoS',
            width: 800,
            height: 1200,
            mimeType: 'image/jpeg',
            size: 291628,
        ...
        },
        {
          ...
          asset: {
            url: 'https://media.graphassets.com/inVAUZvQTdSjQK9heg9M',
            width: 800,
            height: 1200,
            mimeType: 'image/jpeg',
            size: 729068,
        ...
        },
        {
          ...
          asset: {
            url: 'https://media.graphassets.com/CTkHiA24S1uEcFSvvITK',
            width: 800,
            height: 1200,
            mimeType: 'image/jpeg',
            size: 412915,
        ...
        },
        {
          ...
          asset: {
            url: 'https://media.graphassets.com/3YEkPr6QIx36AQgGBmsg',
            width: 800,
            height: 1200,
            mimeType: 'image/jpeg',
            size: 495180,
    ...
    {
      id: 'ckiaaa4a84dzi0a55yeb7s87f',
      __typename: 'RowSpecialBanner',
      asset: {
        url: 'https://media.graphassets.com/jD667rD9RkCoaaGhInnD',
        width: 1532,
        height: 1678,
        mimeType: 'image/jpeg',
        size: 1247616,
      ...
      pageLinks: [
        {
          ...
          asset: {
            url: 'https://media.graphassets.com/34q67ooES1K0PiGF10mc',
            width: 209,
            height: 53,
        ...
        },
        {
          ...
          asset: {
            url: 'https://media.graphassets.com/Y6vfJiw0S0aq04VGG4AI',
            width: 1000,
            height: 356,
            mimeType: 'image/svg+xml',
            size: 966,
        ...
        {
          id: 'cleyajm7n1g2d0bujj1anpa8m',
          title: 'McDonalds',
          url: '/',
          description: null,
          asset: {
            url: 'https://media.graphassets.com/tVbVR01EQ2u2JsMyEXWz',
            width: 296,
            height: 238,
            mimeType: 'image/svg+xml',
            size: 1714,
        ...
        {
          id: 'clf0vc22vmco70bupz40i0bxd',
          title: 'Marvel',
          url: '/',
          description: null,
          asset: {
            url: 'https://media.graphassets.com/3bQ33k13RvKZENhCpGJc',
            width: 1001,
            height: 403,
            mimeType: 'image/svg+xml',
            size: 3229,
