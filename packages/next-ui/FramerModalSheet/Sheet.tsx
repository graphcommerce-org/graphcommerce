import { useSpring, useMotionValue, PanInfo } from 'framer-motion'
...
const Sheet = React.forwardRef<any, SheetProps>((props, ref) => {
  ...
  const sheetDragY = useMotionValue(global.window?.innerHeight ?? 0)
  ...
  const wrapperProps: JSX.IntrinsicElements['div'] = {
    ...rest,
    ref,
    style: { ...styles.wrapper, pointerEvents },
  }
