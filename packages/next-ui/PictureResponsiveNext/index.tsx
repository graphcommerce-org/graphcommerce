...
const PictureResponsiveNext = React.forwardRef<HTMLImageElement, PictureResponsiveNextProps>(
  ({ src, type, ...imgProps }, ref) => {
      ...
      switch (type) {
        ...
        default:
          srcSets['image/webp'] = widths
            .map((width) => url(width, 'webp', '&lossless=1'))
            .join(', ')
    ...
    return <PictureResponsive {...imgProps} srcSets={srcSets} ref={ref} />
  },
)
