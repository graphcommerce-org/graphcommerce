...
const dynamicRow = async (schema) => {
    ...
    // ? COMPONENTS
    (0, functions_1.migrationAction)(schema, 'component', 'create', {
        displayName: 'Text',
        apiId: 'ConditionText',
    ...
    (0, functions_1.migrationAction)(schema, 'componentUnionField', 'create', {
    ...
    (0, functions_1.migrationAction)(schema, 'unionField', 'create', {
        displayName: 'Row',
        apiId: 'row',
        reverseField: {
