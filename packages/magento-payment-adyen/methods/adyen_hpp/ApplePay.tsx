...
import { useAdyenPaymentMethod, usePaymentMethodsResponse } from '../../hooks/useAdyenPaymentMethod'
...
export default function ApplePay(props) {
  ...
  useEffect(() => {
    if (!conf?.paymentMethodsResponse || !paymentContainer.current) {
      return
    }
