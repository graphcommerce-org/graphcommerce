...
/**
 * Custom content types for the Pagebuilder component must implement this interface. Should be
 * written as an ES Module—a module that exports functions with these names, rather than an object
 * with these functions as properties.
 *
