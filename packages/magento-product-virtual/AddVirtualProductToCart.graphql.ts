...
export const AddVirtualProductsToCartDocument: DocumentNode<
...
export type AddVirtualProductsToCartMutationVariables = Types.Exact<{
...
export type AddVirtualProductsToCartMutation = {
  addVirtualProductsToCart?: Types.Maybe<{
