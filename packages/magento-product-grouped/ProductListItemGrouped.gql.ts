...
export const ProductListItemGroupedFragmentDoc: DocumentNode<
  ...
  definitions: [
    {
      ...
      name: { kind: 'Name', value: 'ProductListItemGrouped' },
...
export type ProductListItemGroupedFragment = ProductListItem_GroupedProduct_Fragment
