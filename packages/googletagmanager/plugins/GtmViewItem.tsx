...
function GtmViewItem(props: PluginProps<React.ComponentProps<typeof ProductPageMeta>>) {
  ...
  useEffect(
    () => globalThis.dataLayer.push({ event: 'view_item', ecommerce: viewItem }),
    [viewItem],
  )
...
export const Plugin = GtmViewItem
