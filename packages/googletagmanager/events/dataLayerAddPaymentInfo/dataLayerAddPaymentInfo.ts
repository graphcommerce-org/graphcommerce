import { DataLayerAddPaymentInfoFragment } from './DataLayerAddPaymentInfo.gql'

export function dataLayerAddPaymentInfo<C extends DataLayerAddPaymentInfoFragment>(
  cart?: C | null,
) {
