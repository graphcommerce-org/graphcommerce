import { DataLayerAddShippingInfoFragment } from './DataLayerAddShippingInfo.gql'

export function dataLayerAddShippingInfo<C extends DataLayerAddShippingInfoFragment>(
  cart?: C | null,
) {
  if (!cart) return
