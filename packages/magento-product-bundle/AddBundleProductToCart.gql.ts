...
export const AddBundleProductToCartDocument: DocumentNode<
  AddBundleProductToCartMutation,
  AddBundleProductToCartMutationVariables
> = {
  kind: 'Document',
  definitions: [
    {
      ...
      operation: 'mutation',
      name: { kind: 'Name', value: 'AddBundleProductToCart' },
      variableDefinitions: [
        {
        ...
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'bundleOptions' } },
          type: {
            kind: 'NonNullType',
            type: {
              kind: 'ListType',
              type: {
                kind: 'NonNullType',
                type: { kind: 'NamedType', name: { kind: 'Name', value: 'BundleOptionInput' } },
              },
            },
          },
        },
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'addBundleProductsToCart' },
            arguments: [
              {
                kind: 'Argument',
                        ...
                        values: [
                          {
                            ...
                            fields: [
                              ...
                              },
                              {
                                ...
                                value: {
                                  kind: 'Variable',
                                  name: { kind: 'Name', value: 'bundleOptions' },
                                },
                              },
                            ],
                          },
...
export type AddBundleProductToCartMutationVariables = Types.Exact<{
  cartId: Types.Scalars['String']
  sku: Types.Scalars['String']
  bundleOptions: Array<Types.BundleOptionInput> | Types.BundleOptionInput
...
export type AddBundleProductToCartMutation = {
  addBundleProductsToCart?: Types.Maybe<{
