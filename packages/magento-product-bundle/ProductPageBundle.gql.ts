...
export const ProductPageBundleDocument: DocumentNode<
  ProductPageBundleQuery,
  ProductPageBundleQueryVariables
> = {
  kind: 'Document',
  definitions: [
    {
      ki@reachdigital/magento-product/ProductCustomizable/ProductPageCustomizable.gql
      operation: 'query',
...
export type ProductPageBundleQueryVariables = Types.Exact<{
  urlKey?: Types.Maybe<Types.Scalars['String']>
}>

export type ProductPageBundleQuery = {
