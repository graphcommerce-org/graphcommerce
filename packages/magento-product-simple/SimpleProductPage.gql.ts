...
export const SimpleProductPageDocument: DocumentNode<
  SimpleProductPageQuery,
  SimpleProductPageQueryVariables
> = {
  kind: 'Document',
  definitions: [
    {
      ...
      operation: 'query',
      name: { kind: 'Name', value: 'SimpleProductPage' },
      variableDefinitions: [
        {
...
export type SimpleProductPageQuery = {
  typeProducts?: Types.Maybe<{
    items?: Types.Maybe<
      Array<
        Types.Maybe<
          | { __typename: 'VirtualProduct' }
          | ({ __typename: 'SimpleProduct' } & Pick<Types.SimpleProduct, 'weight'> & {
                options?: Types.Maybe<
                  Array<
                    Types.Maybe<
