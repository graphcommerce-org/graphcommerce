...
export const ProductSimpleDocument: DocumentNode<
  ProductSimpleQuery,
  ProductSimpleQueryVariables
> = {
  kind: 'Document',
  definitions: [
    {
      ...
      operation: 'query',
      name: { kind: 'Name', value: 'ProductSimple' },
      variableDefinitions: [
        {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            alias: { kind: 'Name', value: 'simpleProducts' },
...
export type ProductSimpleQueryVariables = Types.Exact<{
  urlKey?: Types.Maybe<Types.Scalars['String']>
}>

export type ProductSimpleQuery = {
  simpleProducts?: Types.Maybe<{
    items?: Types.Maybe<
      Array<
        Types.Maybe<
          Pick<Types.SimpleProduct, 'weight'> & {
            options?: Types.Maybe<
              Array<
                Types.Maybe<
