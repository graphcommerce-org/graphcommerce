...
export * from './ChangePasswordForm/ChangePassword.graphql'
export { default as ForgotPasswordForm } from './ForgotPasswordForm/ForgotPasswordForm'
export * from './ForgotPasswordForm/ForgotPassword.graphql'
...
export * from './SignInForm/SignIn.graphql'
export * from './SignUpForm/SignUp.graphql'
