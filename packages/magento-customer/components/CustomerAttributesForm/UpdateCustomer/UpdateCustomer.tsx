...
import type { UpdateCustomerMutation } from './UpdateCustomer.gql'
import { UpdateCustomerDocument } from './UpdateCustomer.gql'
import {
...
export function UpdateCustomerForm(props: { customer: CustomerInfoFragment }) {
  ...
  const form = useFormGqlMutation<UpdateCustomerMutation, UpdateCustomerFormValues>(
