...
2. Configure your aggregations/filters, make sure that the aggregation fields
   ...
   Make sure to add 'visibility_search' and 'visibility_catalog' for proper
   usage of those attributes
...
4. To configure sorting options, enable Virtual Replica's.
   > Stores > Configuration > Algolia Search > Instant Search Results Page > Use
   > Virtual Replica
