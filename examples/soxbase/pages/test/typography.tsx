  ...
  return (
    <Container>
      ...
      <Typography variant='h4' display='block' paragraph>
        ...
        turpis euismod gravida. Nunc eu hendrerit leo. Gebruik: Aantal regels tekst. Voorbeeld:
        Product pagina
      </Typography>
      <Typography variant='h5' display='block'>
        Headline 5 — Morbi posuere nunc diam Gebruik: ??, Voorbeeld: ??
      </Typography>
      <Typography variant='h6' display='block'>
        Headline 6 — Ut luctus mi ante Gebruik: ??, Voorbeeld: ??
      </Typography>
      <Typography variant='subtitle1' display='block' paragraph>
        Subtitle 1 — In dictum velit quis lorem dignissim volutpat. Gebruik: Als één of twee regels
        tekst onder een titel, Voorbeeld: 404 pagina bijvoorbeeld
      </Typography>
      ...
      <Typography variant='body2' display='block' paragraph>
        ...
        sodales. Maecenas aliquam pulvinar libero non consectetur. Gebruik: Minder relevante
        teksten. Voorbeeld: ???
      </Typography>
      ...
      <Typography variant='caption' display='block'>
        vitae enim quis cursus. Gebruik: Eén of twee zinnen max. Voorbeeld: Validatie meldingen in
        formulieren en formulier labels, Next Day Delivery op product page
      </Typography>

      <Typography variant='overline' display='block'>
        Nunc scelerisque at massa nec imperdiet
      </Typography>
    </Container>
  )
}
