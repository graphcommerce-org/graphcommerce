...
export const RowSpecialBannerFragmentDoc: DocumentNode<RowSpecialBannerFragment, unknown> = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'RowSpecialBanner' },
      typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'RowSpecialBanner' } },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
...
export type RowSpecialBannerFragment = Pick<Types.RowSpecialBanner, 'topic'> & {
  asset: AssetFragment
