...
const useStyles = makeStyles(
  (theme: Theme) => ({
    container: {
      display: 'grid',
      gridTemplateColumns: 'minmax(min-content, 1200px)',
      ...
      <div className={classes.grid}>
        <div>
          ...
          <Typography variant='body1'>
            Tell your brand’s story with rich content product pages and category landing pages. You
            can easily put pages together using content components.
          </Typography>
        </div>
        <div>
        ...
        <div>
          ...
          <Typography variant='body1'>
            GraphCommerce® helps you score green Core Web Vitals with little to no effort, thanks to
            built-in features like static generation, bundled JS, viewport URL prefetching and more.
          </Typography>
        </div>
        <div>
        ...
        <div>
          ...
          <Typography variant='body1'>
            ...
            production-quality defaults for drawer interfaces, floatable buttons, on-page mega menus
            and more.
          </Typography>
        </div>
      </div>
